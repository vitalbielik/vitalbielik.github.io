      ...
      <div className="container mx-auto px-4 relative z-20 text-white pt-24">
        <div className="max-w-3xl">
          <motion.div
            ...
            className="mb-4"
          >
            <span className="inline-block py-1 px-3 rounded-full bg-primary-700/80 text-xs uppercase tracking-wider font-medium mb-4">
          ...
          >
            Unlocking Human Potential Through Depth Psychology
          </motion.h1>
          ...
          >
            We bring together coaches who integrate psychoanalytic principles into their practice, 
            fostering transformative growth and lasting change.
          </motion.p>
